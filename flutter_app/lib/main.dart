              ...
              Container(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    if (controller.localDeathHistory.isNotEmpty)
                      Text(
                        '墓地 ${controller.localDeathHistory.length} · ${controller.localDeathHistory.reversed.take(2).map((record) => record.name).join('/')}',
                        style: const TextStyle(
                          color: Color(0xFFC9AAA0),
                          fontSize: 10,
                        ),
                      ),
