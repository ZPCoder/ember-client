...
- 炉石式卡牌属性：战吼、亡语、嘲讽、护盾、冲锋、突袭、风怒、剧毒、潜行、复生、冻结、汲取、激昂、武器、奥秘、发现、抉择、连击、过载、可交易、预备、贿赂、伪装、破碎、先驱、巨型、法术伤害、沉默、变形和临时增益；支持破碎卡加入手牌时裂至两端、片段单独使用与相邻重组，支持先驱在 2/4 次阈值强化士兵及巨型本体/附肢、伪装单位部署到任一方战场并由接收方控制、同名二星升阶、亡语召唤、复生回场、护盾抵伤、剧毒击杀、冻结跳过攻击、风怒双攻击、英雄武器攻击与回合触发
